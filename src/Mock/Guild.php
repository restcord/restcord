...
{
    /**
     * @param array $options ['access_token' => 'string', 'nick' => 'string', 'roles' => 'array', 'mute' => 'bool', 'deaf' => 'bool', 'guild.id' => 'snowflake', 'user.id' => 'snowflake']
     *
    ...
    /**
     * @param array $options ['days' => 'integer', 'guild.id' => 'snowflake']
     *
     ...
     *
     * @return \RestCord\Response\Guild\Guild Returns a guild object on success.
     */
    public function createGuild(array $options);

    /**
     * @param array $options ['delete-message-days' => 'integer', 'guild.id' => 'snowflake', 'user.id' => 'snowflake']
     *
     * @return array Returns a 204 empty response on success.
     */
    ...
    /**
     * @param array $options ['name' => 'string', 'type' => 'string', 'bitrate' => 'integer', 'user_limit' => 'integer', 'permission_overwrites' => 'array', 'guild.id' => 'snowflake']
     *
    ...
    /**
     * @param array $options ['type' => 'string', 'id' => 'snowflake', 'guild.id' => 'snowflake']
     *
     * @return array Returns a 204 empty response on success.
     */
    ...
    /**
     * @param array $options ['name' => 'string', 'permissions' => 'integer', 'color' => 'integer', 'hoist' => 'bool', 'mentionable' => 'bool', 'guild.id' => 'snowflake']
     *
     ...
     *
     * @return \RestCord\Response\Guild\Guild Returns the guild object on success.
     */
     ...
     * @param array $options ['guild.id' => 'snowflake']
     *
     * @return \RestCord\Response\Guild\Guild Returns the new guild object for the given id.
     */
     ...
     * @param array $options ['guild.id' => 'snowflake']
     *
     * @return \RestCord\Response\Guild\Integration Returns a list of integration objects for the guild.
     */
    ...
    /**
     * @param array $options ['limit' => 'integer', 'after' => 'integer', 'guild.id' => 'snowflake']
     *
    ...
    /**
     * @param array $options ['nick' => 'string', 'guild.id' => 'snowflake']
     *
    ...
    /**
     * @param array $options ['name' => 'string', 'region' => 'string', 'verification_level' => 'integer', 'default_message_notifications' => 'integer', 'afk_channel_id' => 'snowflake', 'afk_timeout' => 'integer', 'icon' => 'string', 'owner_id' => 'snowflake', 'splash' => 'string', 'guild.id' => 'snowflake']
     *
     * @return \RestCord\Response\Guild\Guild Returns the updated guild object on success.
     */
    public function modifyGuild(array $options);

    /**
     * @param array $options ['id' => 'snowflake', 'position' => 'integer', 'guild.id' => 'snowflake']
     *
    ...
    /**
     * @param array $options ['expire_behavior' => 'integer', 'expire_grace_period' => 'integer', 'enable_emoticons' => 'bool', 'guild.id' => 'snowflake', 'integration.id' => 'string']
     *
     * @return array Returns a 204 empty response on success.
     */
    ...
    /**
     * @param array $options ['nick' => 'string', 'roles' => 'array', 'mute' => 'bool', 'deaf' => 'bool', 'channel_id' => 'snowflake', 'guild.id' => 'snowflake', 'user.id' => 'snowflake']
     *
     * @return array Returns a 204 empty response on success.
     */
    ...
    /**
     * @param array $options ['name' => 'string', 'permissions' => 'integer', 'color' => 'integer', 'hoist' => 'bool', 'mentionable' => 'bool', 'guild.id' => 'snowflake', 'role.id' => 'string']
     *
