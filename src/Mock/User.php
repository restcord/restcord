...
interface User {
	...
	/**
	 * @param array $options []
	 * @return \RestCord\Response\User\User Returns the user object of the requester's account.
	 */
	 ...
	 * @return \RestCord\Response\User\User Returns a user for a given user ID.
	 */
	...
	/**
	 * @param array $options []
	 * @return \RestCord\Response\User\Connection Returns a list of connection objects.
	 */
	 ...
	 * @return \RestCord\Response\User\User Returns a user object on success.
	 */
